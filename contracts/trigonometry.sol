...
library Trigonometry {
    ...
    uint256 constant entry_bytes = 2;
     ...
     *         _offset bit
     */
    function bits(uint256 _value, uint256 _width, uint256 _offset) pure internal returns (uint256) {
        return (_value / (2 ** _offset)) & (((2 ** _width)) - 1);
    }

    function sin_table_lookup(uint256 index) pure internal returns (uint256) {
